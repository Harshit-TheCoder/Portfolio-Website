...
import Achievements_Component from "./components/achievement_component";
        ...
        <div>
            ...
            <Main>
                ...
                <div className="achievements-container">
                    ...
                    <Achievements_Component images={[aimlimg4,aimlimg1,aimlimg2,aimlimg3]} heading={"Course on Artificial Intelligence and Machine Learning with Python"} content={"I had successfully completed the course on Artificial Intelligence and Machine Learning. Towards the end of the course I appeared for a"+
                                                                                                        "Microsoft Azure Certification Exam, qualifying which I got Microsoft Certified in Azure Fundamentals."}/>
                    
                    <Achievements_Component images={[cimg]} heading={"Course on C Language"} content={"I had successfully completed the course on C Language from Udemy. The Course gave me deep insights of the language and helped me develop fascinating codes by myself."}/>
                    <Achievements_Component images={[cppimg]} heading={"Course on C++ Language"} content={"I had successfully completed the course on C++ Language from Udemy. The Course gave me deep insights of the language and helped me develop fascinating codes by myself."}/>
                    <Achievements_Component images={[pyimg]} heading={"Bootcamp on Python Language"} content={"I had successfully completed the Bootcamp on Python Language from Udemy. The Bootcamp gave me deep insights of the language and helped me develop fascinating codes by myself."+
